...
if __name__=="__main__":
    score=0
    random.shuffle(quiz_database)
    for i in range(1,4):
        print(f'Question {i} of 3')
        if ask_question(quiz_database[i]):
            print("Correct!\n")
            score += 1
        else:
            print(f"Wrong! The correct answer is {quiz_database[i]['answer']}.\n")
    print("You scored {}/3.".format(score))